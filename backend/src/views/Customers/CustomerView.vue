...
const billingCountry = computed(() => {
  if (customer.value.billingAddress.country_code) {
    return  store.state.countries.find(c => c.code === customer.value.billingAddress.country_code)
  }
  return {states: {}};
})
...
const shippingCountry = computed(() => {
  if (customer.value.shippingAddress.country_code) {
    return  store.state.countries.find(c => c.code === customer.value.shippingAddress.country_code)
  }
  return {states: {}};
})
